...
function Home() {
  return (
    <div>
      <a href="/" className="flex w-full mb-4 h-20 items-center justify-center bg-[#16611d] text-xl text-white md:hidden font-semibold text-center ">CONTACT FOR DEALERSHIP</a>
      <div className="w-[96vw] mx-[2vw] h-[50vh] md:h-screen bg-[url('https://upload.wikimedia.org/wikipedia/commons/0/0b/DiwaliKarnal.JPG')] bg-center bg-cover bg-no-repeat">
